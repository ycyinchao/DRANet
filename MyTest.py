...
from lib.models.detectors.detector11_DRANet import Network
from utils.sdy_data_val import test_dataset

parser = argparse.ArgumentParser()
parser.add_argument('--testsize', type=int, default=384, help='testing size')
parser.add_argument('--pth_path', type=str, default='./checkpoints/11_DRANet_test_2/Net_epoch_best.pth')
